    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Exclusão de Matrícula</li>
            </ol>
        </section>
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="login-box ">
                        ...
                        <h3>Realmente deseja excluir a matrícula ?</h3>
                        <div class="">
                            <a href="{{ route('Painel.Matriculas.forceDestroy',$cat->id) }}" type="submit" class="btn btn-primary pull-left">Excluir</a>
