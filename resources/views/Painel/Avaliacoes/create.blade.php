                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            <h3 class="box-title">Cadastrando avalaliação</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <form role="form" method="POST" action="{{ route('Painel.Avaliacoes.store') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="bracoDireito"
                                           ...
                                           name="bracoDireito" value="{{old('bracoDireito')}}" required>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="bracoEsquerdo"
                                           placeholder="Ex: 22,35"
                                           name="bracoEsquerdo" value="{{old('bracoEsquerdo')}}" required>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="antebracoDireito"
                                           placeholder="Ex: 22,35"
                                           name="antebracoDireito" value="{{old('antebracoDireito')}}" required>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="antebracoEsquerdo"
                                           placeholder="Ex: 22,35 "
                                           name="antebracoEsquerdo" value="{{old('antebracoEsquerdo')}}" required>
                                </div>
                                </div>
                                ...
                                <div class="form-group col-xs-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="busto"
                                               placeholder="Ex: 22,35 "
                                               name="busto" value="{{old('busto')}}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="peito"
                                           placeholder="Ex: 22,35 "
                                           name="peito" value="{{old('peito')}}" required>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="cintura"
                                           placeholder="Ex: 22,35 "
                                           name="cintura" value="{{old('cintura')}}" required>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="quadril"
                                           placeholder="Ex: 22,35 "
                                           name="quadril" value="{{old('quadril')}}" required>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="coxaDireita"
                                           placeholder="Ex: 22,35 "
                                           name="coxaDireita" value="{{old('coxaDireita')}}" required>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="coxaEsquerda"
                                           placeholder="Ex: 22,35 "
                                           name="coxaEsquerda" value="{{old('coxaEsquerda')}}" required>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="panturrilhaDireita"
                                           placeholder="Ex: 22,35 "
                                           name="panturrilhaDireita" value="{{old('panturrilhaDireita')}}" required>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="panturrilhaEsquerda"
                                           placeholder="Ex: 22,35 "
                                           name="panturrilhaEsquerda" value="{{old('panturrilhaEsquerda')}}" required>
                                </div>
                                </div>
