                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body">
                            @if ($errors->any())
                                ...
                                <br/>
                            @endif
                            <form role="form" method="POST" action="{{ route('Painel.Treinoturmas.store') }}">
                                ...
                                <input id="turma_id"
                                       name="turma_id" value="{{$turma->id}}" hidden>
                                ...
                                <div class="box-footer">
                                    ...
                                    <a href="{{ route('Painel.Treinoturmas.index') }}" type="submit" class="btn btn-danger pull-right">Cancelar</a>
                                </div>
                            </form>
                        </div>
                    </div>
