    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Exclusão de Plano</li>
            </ol>
        </section>
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="login-box ">
                        ...
                        <h3>Realmente deseja excluir o plano ?</h3>
                        <div class="">
                            <a href="{{ route('Painel.Planos.destroy',$cat->id) }}" type="submit" class="btn btn-primary pull-left">Excluir</a>
